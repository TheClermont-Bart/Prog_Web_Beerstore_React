            ...
            <div className="container-fluid">
              ...
              <div className="collapse navbar-collapse d-flex justify-content-lg-around " id="navbarNavDropdown">
                <ul className="navbar-nav ">
                  ...
                  <li className="nav-item">
                    <a className="nav-link link-dark link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="ventes">Inventaire</a>
                  </li>
                  <li className="nav-item">
